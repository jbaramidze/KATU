...
#include "lusol2.cc"      /* Heap management */
#include "lusol6a.cc"     /* Singularity checking and equation solving */
#include "lusol1.cc"      /* Factorization and core components */
#include "lusol7a.cc"     /* Utility routines for updates */
#include "lusol8a.cc"     /* Column update */
